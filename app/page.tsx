  ...
  return (
    <div className="lg:w-full sm:w-screen">
      <div className="items-center justify-center font-mono text-sm flex-col  p-14">
        <h2 className="text-2xl font-bold text-gray-800 text-center">Bienvenido a Post Graph</h2>
        <h5 className="text-sm font-semibold text-gray-500 text-center">
        ...
        <div>
          ...
          >
            <div className="flex items-center justify-end gap-4">
              <Link href={`/graphic`}>
                <button className="text-red-600 hover:text-red-500  bg-red-100 hover:bg-red-50 px-4 py-2 mb-4 rounded">
